...
function Cascading(idTarget, parentIdControl, urlGetJson, promptText) {
    CascadingLoaded(idTarget, parentIdControl, urlGetJson, promptText, null);
}

function CascadingLoaded(idTarget, parentIdControl, urlGetJson, promptText, onLoadedFunc) {
    //Attach cascading behavior to the orderID select element.
    $(idTarget).CascadingDropDown(parentIdControl, urlGetJson,
            {
